...
def parse_args(args=None):
    ...
    parser.add_argument("-d", "--download_dir", type=str, default="./downloads/corruption/", help="download directory")
    parser.add_argument("-k", "--keyword", type=str, default="corruption", help="search keyword")
